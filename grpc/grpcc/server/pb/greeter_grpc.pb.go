...
const (
	...
	Greeter_Singup_FullMethodName   = "/pb.Greeter/Singup"
)
...
func (c *greeterClient) Singup(ctx context.Context, in *SingupRequest, opts ...grpc.CallOption) (*SingupResponse, error) {
...
func (UnimplementedGreeterServer) Singup(context.Context, *SingupRequest) (*SingupResponse, error) {
...
func _Greeter_Singup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Singup(ctx, req.(*SingupRequest))
	}
	return interceptor(ctx, in, info, handler)
}
